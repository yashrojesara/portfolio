export const projectList = [
  {
    ...
    technology: "NodeJS",
    githubLink: "https://github.com/yashrojesara/mark1",
    liveLink:
  ...
  {
    id: 2,
    title: "Quiz about cricket 🏏 ",
    date: "July-22",
    description:
      "Quiz about cricket where you can choose answers from given options",
    technology: "NodeJS",
    githubLink: " https://github.com/yashrojesara/mark2 ",
    liveLink:
